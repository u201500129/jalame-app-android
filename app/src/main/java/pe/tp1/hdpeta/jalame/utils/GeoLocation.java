...
public class GeoLocation {
     ...
     */
    public GeoLocation(Context context) { //***ALF:esta es la clase Geolocalización**/
    ...
    /**
     * Crear una nueva instancia de Geolocalizacion ALF: aca los parametros que necesita para trabajar google
